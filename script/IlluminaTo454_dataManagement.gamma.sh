...
LTR="/home/andrea/Dropbox/TIGET/Workbench/ISAtools/NGS/LTR.gamma.fa";
...
fastq-mcf ${ADAPTER454_A} ${OUTDIR}/${PATIENT}_${POOL}_join.ltr.fastq.gz -o ${OUTDIR}/${PATIENT}_${POOL}_join.ltr.noA.fastq.gz -m 19 -p 1 -l 30 -q 10 -P 33 -R -k 0 -x 0 -S
fastq-mcf ${ADAPTER454_B} ${OUTDIR}/${PATIENT}_${POOL}_join.ltr.noA.fastq.gz -o ${OUTDIR}/${PATIENT}_${POOL}_join.ltr.noAB.fastq.gz -m 15 -p 20 -l 30 -q 10 -P 33 -R -k 0 -x 0 -S
...
flexbar --source <(zcat ${OUTDIR}/${PATIENT}_${POOL}_un1.fastq.gz) --source2 <(zcat ${OUTDIR}/${PATIENT}_${POOL}_un1.fastq.gz) --target ${TMPDIR}/${PATIENT}_${POOL}_single.fb.ltr -f fastq-i1.8 -a ${LTR} --threads 8 -ae ANY -at 0.5 -ao 50 -aa -m 20 -q 10 --removal-tag
# get only reads headers
...
fastq-mcf ${ADAPTER454_A} ${OUTDIR}/${PATIENT}_${POOL}_single.ltr.fastq.gz -o ${OUTDIR}/${PATIENT}_${POOL}_single.ltr.noA.fastq.gz -m 19 -p 1 -l 30 -q 10 -P 33 -R -k 0 -x 0 -S
fastq-mcf ${ADAPTER454_B} ${OUTDIR}/${PATIENT}_${POOL}_single.ltr.noA.fastq.gz -o ${OUTDIR}/${PATIENT}_${POOL}_single.ltr.noAB.fastq.gz -m 15 -p 20 -l 30 -q 10 -P 33 -R -k 0 -x 0 -S
