...
###################### Download Genome ######################
	...
	sudo cp -rf /opt/applications/scripts/vispa2/genomes/phix/bwa7/* /opt/genome/control/phix174/bwa_7/
	sudo cp -rf /opt/applications/scripts/vispa2/genomes/lv/bwa_7/* /opt/genome/vector/lv/bwa_7/
	sudo cp -rf /opt/applications/scripts/vispa2/genomes/alu/* /opt/genome/vector/alu/
